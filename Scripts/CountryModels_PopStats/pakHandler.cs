...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class pak
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["PAKPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public pak(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.pak_admpop_adm3.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.pak_admpop_adm3> jsonResult;
                //JToken jt = resquery;
