...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class mdg
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["MDGPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public mdg(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.mdg_pop_adm4.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.mdg_pop_adm4> jsonResult;
                //JToken jt = resquery;
