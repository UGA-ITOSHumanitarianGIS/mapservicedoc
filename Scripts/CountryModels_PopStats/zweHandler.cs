...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class zwe
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["ZWEPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public zwe(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.zwe_admpop_adm1_2021.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.zwe_admpop_adm1_2021> jsonResult;
                //JToken jt = resquery;
