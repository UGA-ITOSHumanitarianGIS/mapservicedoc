...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class grd
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["GRDPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public grd(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.grd_admpop_adm1_2011.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.grd_admpop_adm1_2011> jsonResult;
                //JToken jt = resquery;
