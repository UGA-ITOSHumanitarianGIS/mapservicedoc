...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class irn
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["IRNPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public irn(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.irn_admpop_adm2_2019.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.irn_admpop_adm2_2019> jsonResult;
                //JToken jt = resquery;
