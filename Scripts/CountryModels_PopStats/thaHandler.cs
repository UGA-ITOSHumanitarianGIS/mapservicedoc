...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class tha
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["THAPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public tha(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.tha_admpop_adm2_2020.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.tha_admpop_adm2_2020> jsonResult;
                //JToken jt = resquery;
