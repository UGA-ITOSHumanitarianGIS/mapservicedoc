...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class blm
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["BLMPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public blm(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.blm_admpop_adm1_2016_insee.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.blm_admpop_adm1_2016_insee> jsonResult;
                //JToken jt = resquery;
