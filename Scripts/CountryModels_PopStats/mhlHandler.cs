...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class mhl
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["MHLPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public mhl(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.mhl_pplp_adm2_eas.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.mhl_pplp_adm2_eas> jsonResult;
                //JToken jt = resquery;
