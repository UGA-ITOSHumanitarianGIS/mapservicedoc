...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class hun
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["HUNPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public hun(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.hun_admpop_adm1_2022_v01.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.hun_admpop_adm1_2022_v01> jsonResult;
                //JToken jt = resquery;
