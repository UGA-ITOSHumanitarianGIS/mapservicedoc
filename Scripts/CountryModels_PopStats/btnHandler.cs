...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class btn
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["BTNPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public btn(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.btn_admpop_adm1_unfpa_2022.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.btn_admpop_adm1_unfpa_2022> jsonResult;
                //JToken jt = resquery;
