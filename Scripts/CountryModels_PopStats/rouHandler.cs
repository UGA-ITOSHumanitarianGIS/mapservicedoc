...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class rou
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["ROUPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public rou(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.rou_admpop_adm2_2022_v01.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.rou_admpop_adm2_2022_v01> jsonResult;
                //JToken jt = resquery;
