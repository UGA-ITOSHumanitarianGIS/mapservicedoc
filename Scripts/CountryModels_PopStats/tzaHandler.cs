...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class tza
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["TZAPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public tza(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.tza_admpop_adm2_2000.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.tza_admpop_adm2_2000> jsonResult;
                //JToken jt = resquery;
