...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class bgd
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["BGDPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public bgd(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.bgd_admpop_adm3_bd.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.bgd_admpop_adm3_bd> jsonResult;
                //JToken jt = resquery;
