...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class ury
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["URYPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public ury(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.ury_adm1_pop.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.ury_adm1_pop> jsonResult;
                //JToken jt = resquery;
