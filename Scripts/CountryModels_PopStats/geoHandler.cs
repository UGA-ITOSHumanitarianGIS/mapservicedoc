...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class geo
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["GEOPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public geo(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.geo_admpop_adm2.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.geo_admpop_adm2> jsonResult;
                //JToken jt = resquery;
