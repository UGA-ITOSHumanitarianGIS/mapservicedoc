...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class dom
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["DOMPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public dom(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.dom_admpop_adm3_2020.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.dom_admpop_adm3_2020> jsonResult;
                //JToken jt = resquery;
