...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class mli
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["MLIPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public mli(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.mli_pop_adm3.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.mli_pop_adm3> jsonResult;
                //JToken jt = resquery;
