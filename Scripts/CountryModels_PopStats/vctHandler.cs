...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class vct
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["VCTPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public vct(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.vct_admpop_adm2_2012.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.vct_admpop_adm2_2012> jsonResult;
                //JToken jt = resquery;
