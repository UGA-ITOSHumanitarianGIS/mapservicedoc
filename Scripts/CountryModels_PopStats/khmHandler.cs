...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class khm
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["KHMPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public khm(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.khm_admpop_adm2_2016.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.khm_admpop_adm2_2016> jsonResult;
                //JToken jt = resquery;
