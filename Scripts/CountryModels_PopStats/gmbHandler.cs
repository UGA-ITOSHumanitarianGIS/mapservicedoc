...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class gmb
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["GMBPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public gmb(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.gmb_popadm_2021_admin1.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.gmb_popadm_2021_admin1> jsonResult;
                //JToken jt = resquery;
