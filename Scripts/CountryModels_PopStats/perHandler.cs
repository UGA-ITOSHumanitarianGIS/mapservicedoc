...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class per
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["PERPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public per(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.per_admpop_adm1_2022.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.per_admpop_adm1_2022> jsonResult;
                //JToken jt = resquery;
