...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class nam
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["NAMPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public nam(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.nam_admpop_adm2_2020.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.nam_admpop_adm2_2020> jsonResult;
                //JToken jt = resquery;
