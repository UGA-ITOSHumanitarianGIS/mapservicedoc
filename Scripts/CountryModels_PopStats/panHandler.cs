...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class pan
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["PANPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public pan(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.pan_admpop_adm1_2022.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.pan_admpop_adm1_2022> jsonResult;
                //JToken jt = resquery;
