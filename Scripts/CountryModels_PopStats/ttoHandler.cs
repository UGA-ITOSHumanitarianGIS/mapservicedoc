...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class tto
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["TTOPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public tto(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.tto_admpop_adm1_2020.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.tto_admpop_adm1_2020> jsonResult;
                //JToken jt = resquery;
