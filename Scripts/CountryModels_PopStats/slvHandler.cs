...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class slv
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["SLVPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public slv(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.slv_admpop_adm2_2022.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.slv_admpop_adm2_2022> jsonResult;
                //JToken jt = resquery;
