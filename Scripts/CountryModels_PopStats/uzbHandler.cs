...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class uzb
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["UZBPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public uzb(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.uzb_admpop_adm1.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.uzb_admpop_adm1> jsonResult;
                //JToken jt = resquery;
