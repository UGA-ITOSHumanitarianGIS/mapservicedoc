...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class arm
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["ARMPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public arm(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.arm_admpop_adm1_2021.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.arm_admpop_adm1_2021> jsonResult;
                //JToken jt = resquery;
