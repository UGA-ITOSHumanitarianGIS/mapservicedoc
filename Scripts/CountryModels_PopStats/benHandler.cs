...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class ben
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["BENPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public ben(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.ben_adm2_pop.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.ben_adm2_pop> jsonResult;
                //JToken jt = resquery;
