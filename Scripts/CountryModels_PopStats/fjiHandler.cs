...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class fji
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["FJIPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public fji(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.fji_pplp_adm3_tikina_2017.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.fji_pplp_adm3_tikina_2017> jsonResult;
                //JToken jt = resquery;
