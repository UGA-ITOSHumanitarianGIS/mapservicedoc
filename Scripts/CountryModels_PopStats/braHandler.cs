...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class bra
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["BRAPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public bra(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.bra_admpop_adm1_2022.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.bra_admpop_adm1_2022> jsonResult;
                //JToken jt = resquery;
