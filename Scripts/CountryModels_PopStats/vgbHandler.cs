...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class vgb
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["VGBPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public vgb(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.vgb_admpop_adm1_2010.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.vgb_admpop_adm1_2010> jsonResult;
                //JToken jt = resquery;
