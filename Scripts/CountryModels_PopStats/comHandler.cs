...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class com
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["COMPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public com(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.com_admpop_adm1_2017.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.com_admpop_adm1_2017> jsonResult;
                //JToken jt = resquery;
