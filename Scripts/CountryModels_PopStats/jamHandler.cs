...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class jam
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["JAMPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public jam(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.jam_adm1_pop.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.jam_adm1_pop> jsonResult;
                //JToken jt = resquery;
