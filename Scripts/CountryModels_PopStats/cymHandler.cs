...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class cym
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["CYMPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public cym(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.cym_admpop_adm1_2010.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.cym_admpop_adm1_2010> jsonResult;
                //JToken jt = resquery;
