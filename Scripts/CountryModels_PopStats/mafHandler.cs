...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class maf
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["MAFPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public maf(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.maf_admpop_adm1_2016_insee.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.maf_admpop_adm1_2016_insee> jsonResult;
                //JToken jt = resquery;
