...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class mwi
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["MWIPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public mwi(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.mwi_admpop_adm2_2021.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.mwi_admpop_adm2_2021> jsonResult;
                //JToken jt = resquery;
