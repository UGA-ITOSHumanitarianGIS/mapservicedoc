...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class vnm
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["VNMPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public vnm(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.vnm_adm1_pop_2019.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.vnm_adm1_pop_2019> jsonResult;
                //JToken jt = resquery;
