...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class cri
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["CRIPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public cri(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.cri_admpop_adm3_unfpa2021.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.cri_admpop_adm3_unfpa2021> jsonResult;
                //JToken jt = resquery;
