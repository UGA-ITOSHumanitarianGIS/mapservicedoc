...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class tca
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["TCAPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public tca(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.tca_admpop_adm1.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.tca_admpop_adm1> jsonResult;
                //JToken jt = resquery;
