...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class lka
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["LKAPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public lka(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.lka_admpop_adm2_2022.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.lka_admpop_adm2_2022> jsonResult;
                //JToken jt = resquery;
