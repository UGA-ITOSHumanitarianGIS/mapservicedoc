...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class lca
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["LCAPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public lca(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.lca_pop_adm1.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.lca_pop_adm1> jsonResult;
                //JToken jt = resquery;
