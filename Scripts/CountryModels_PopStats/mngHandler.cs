...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class mng
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["MNGPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public mng(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.mng_admpop_adm2_2017.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.mng_admpop_adm2_2017> jsonResult;
                //JToken jt = resquery;
