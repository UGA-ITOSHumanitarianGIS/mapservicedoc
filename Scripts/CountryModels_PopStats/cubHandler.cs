...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class cub
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["CUBPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public cub(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.cub_admpop_adm2_2020.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.cub_admpop_adm2_2020> jsonResult;
                //JToken jt = resquery;
