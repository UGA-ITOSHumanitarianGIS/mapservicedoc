...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class fsm
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["FSMPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public fsm(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.fsm_pplp_adm2_municipality.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.fsm_pplp_adm2_municipality> jsonResult;
                //JToken jt = resquery;
