...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class npl
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["NPLPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public npl(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.npl_pop_adm2_v2.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.npl_pop_adm2_v2> jsonResult;
                //JToken jt = resquery;
