...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class bmu
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["BMUPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public bmu(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.bmu_admpop_adm2.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.bmu_admpop_adm2> jsonResult;
                //JToken jt = resquery;
