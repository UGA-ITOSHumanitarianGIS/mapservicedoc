...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class bwa
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["BWAPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public bwa(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.bwa_admpop_adm3_2021.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.bwa_admpop_adm3_2021> jsonResult;
                //JToken jt = resquery;
