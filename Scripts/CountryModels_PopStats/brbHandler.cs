...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class brb
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["BRBPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public brb(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.brb_admpop_adm1_2010.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.brb_admpop_adm1_2010> jsonResult;
                //JToken jt = resquery;
