...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class svk
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["SVKPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public svk(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.svk_admpop_adm2_2021_v01.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.svk_admpop_adm2_2021_v01> jsonResult;
                //JToken jt = resquery;
