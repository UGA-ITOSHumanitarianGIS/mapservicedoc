...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class cpv
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["CPVPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public cpv(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.cpv_admpop_island_2021.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.cpv_admpop_island_2021> jsonResult;
                //JToken jt = resquery;
