...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class msr
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["MSRPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public msr(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.msr_admpop_adm1_2011.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.msr_admpop_adm1_2011> jsonResult;
                //JToken jt = resquery;
