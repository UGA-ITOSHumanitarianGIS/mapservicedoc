...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class png
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["PNGPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public png(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.png_admpop_adm3_2011.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.png_admpop_adm3_2011> jsonResult;
                //JToken jt = resquery;
