...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class chl
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["CHLPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public chl(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.chl_admpop_adm3_2022.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.chl_admpop_adm3_2022> jsonResult;
                //JToken jt = resquery;
