...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class stp
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["STPPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public stp(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.stp_admpop_adm2_2021.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.stp_admpop_adm2_2021> jsonResult;
                //JToken jt = resquery;
