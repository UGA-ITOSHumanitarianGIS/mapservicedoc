...
namespace CODV2API.Handlers.CountryModels_PopStats
{
    ...
    public class bdi
    {
        ...
        int? _level;
        private string CountryYear = ConfigurationManager.AppSettings["BDIPopStats"];
        private ApplicationContext db = new ApplicationContext();

        public bdi(string iso3, int? level)
        {
            this._iso3 = iso3;
            this._level = level;
        }
        ...
        public object popstats(string iso3, int? level)
        {
            ...
            try
            {
                var resquery = db.bdi_admpop_adm2_2021_119_feature.ToList();
                ...
                //System.Web.Http.Results.JsonResult<CODV2API.Models.Country_Models.bdi_admpop_adm2_2021_119_feature> jsonResult;
                //JToken jt = resquery;
