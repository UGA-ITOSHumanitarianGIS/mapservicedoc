...
def fileValidation(fileName = None):
    ...
    '''
    if fileName is None:
        fileName = ''.join(['hdxCODDataPS','.json'])
    else:
...
main('common operational dataset - cod', "['population statistics', 'administrative boundaries']")
